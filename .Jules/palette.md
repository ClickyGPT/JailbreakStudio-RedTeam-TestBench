...
**Learning:** Dropdown menus implemented with only 'group-hover:block' are inaccessible to keyboard users as they never trigger the hover state.
**Action:** Always combine 'group-hover:block' with 'group-focus-within:block' to ensure menus become visible and navigable when the trigger button or menu items receive focus.
