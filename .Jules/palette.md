...
## 2026-03-14 - [Keyboard Productivity as UX]
**Learning:** Adding standard keyboard shortcuts (like `Cmd/Ctrl + Enter` for submission) significantly reduces interaction friction for power users.
**Action:** Always pair keyboard shortcuts with a visual hint (like a tooltip or button label suffix) to ensure the feature is discoverable and not hidden.
