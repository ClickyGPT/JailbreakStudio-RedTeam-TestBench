...
## 2025-05-15 - [Focus Visibility on High-Brightness Backgrounds]
**Learning:** Standard white focus rings are virtually invisible on high-brightness "brand" colors like 'cyber-lime'. This fails accessibility standards for focus indicators.
**Action:** Use high-contrast focus rings (e.g., `focus-visible:ring-black`) when working with bright primary backgrounds to ensure keyboard navigation is accessible.
