...
// BOLT OPTIMIZATION: Parse initial state once outside the component to avoid
// a redundant re-render cycle caused by a useEffect on mount.
...
const App: React.FC = () => {
  ...
  return (
    <div className="flex flex-col h-screen bg-cyber-black text-cyber-text font-sans overflow-hidden relative selection:bg-cyber-lime selection:text-black">
      ...
      {/* Cursor Physics: Spotlight Effect isolated to prevent App re-renders */}
      <Spotlight />
