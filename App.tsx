...
// BOLT OPTIMIZATION: Parse URL state once at the module level to avoid redundant work
// during component mount and prevent an extra state-induced re-render cycle.
const INITIAL_SHARED_STATE = decodeStateFromHash();
