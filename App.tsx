...
const App: React.FC = () => {
  ...
  // Stable references to state to prevent re-renders in children when typing
  ...
  const handleRunTest = React.useCallback(async () => {
    ...
    setResult(simResult);
    setIsRunning(false);
  }, []); // BOLT OPTIMIZATION: Empty deps + promptRef prevents SimulationPanel re-renders on keystroke
  ...
  const handleShare = React.useCallback(() => {
    ...
    setShowShare(true);
  }, []); // BOLT OPTIMIZATION: Empty deps + refs prevents SimulationPanel re-renders
