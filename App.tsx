...
const App: React.FC = () => {
  // BOLT OPTIMIZATION: Use lazy initialization to decode state from URL hash once during mount.
  // This avoids the 'flash of empty content' and the extra render cycle caused by useEffect.
  ...
  return (
    <div className="flex flex-col h-screen bg-cyber-black text-cyber-text font-sans overflow-hidden relative selection:bg-cyber-lime selection:text-black">
      ...
      {/* BOLT OPTIMIZATION: Moved to memoized component to isolate high-frequency reconciliation */}
      <Spotlight />
