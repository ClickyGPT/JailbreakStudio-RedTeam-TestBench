...
// BOLT OPTIMIZATION: Parse URL hash once at module level to avoid redundant calls
// during state initialization and prevent an extra re-render on mount.
...
const App: React.FC = () => {
  ...
  return (
    <div className="flex flex-col h-screen bg-cyber-black text-cyber-text font-sans overflow-hidden relative selection:bg-cyber-lime selection:text-black">
      ...
      {/* Cursor Physics: Spotlight Effect (BOLT OPTIMIZATION: Memoized and isolated) */}
      <Spotlight />
