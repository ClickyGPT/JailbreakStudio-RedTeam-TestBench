...
const Composer: React.FC<ComposerProps> = React.memo(({ prompt, setPrompt, onRunTest, isRunning, onShare }) => {
  ...
  return (
    <div className="flex-1 flex flex-col h-full relative group/composer">
      ...
      <div className="p-4 border-t border-gray-900 bg-cyber-black flex justify-between items-center">
        ...
        >
            <span className="relative z-10 flex items-center gap-2">
                ...
                {!isRunning && (
                    <span className="text-[10px] font-mono opacity-0 group-focus-within/composer:opacity-60 transition-opacity ml-1 select-none">
                        ({isMac ? '⌘↵' : 'Ctrl+Enter'})
                    </span>
                )}
            </span>
