...
// BOLT OPTIMIZATION: Platform detection is a static check. Doing it at the module level
// prevents a redundant state update and re-render during the initial component mount.
...
const Composer: React.FC<ComposerProps> = React.memo(({ prompt, setPrompt, onRunTest, isRunning, onShare }) => {
  // BOLT OPTIMIZATION: Using a ref instead of state for the element reference
  // avoids a redundant re-render when the textarea element is initially established.
