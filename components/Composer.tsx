  ...
  return (
    <div className="flex-1 flex flex-col h-full relative">
                ...
                <div className="absolute right-0 top-full mt-1 w-64 bg-cyber-black border border-gray-800 rounded shadow-2xl hidden group-hover:block group-focus-within:block z-20 max-h-80 overflow-y-auto backdrop-blur-xl">
                    ...
                    {systemVars.map((v) => (
                        <button 
                            ...
                            className="block w-full text-left px-4 py-2 text-xs hover:bg-cyber-lime hover:text-black focus-visible:bg-cyber-lime focus-visible:text-black focus-visible:outline-none text-gray-300 border-b border-gray-900 last:border-0 group/item transition-all"
                    ...
                    <div className="border-t border-gray-800 sticky bottom-0 bg-cyber-black">
                        <button 
                            ...
                            className="block w-full text-left px-4 py-3 text-xs bg-gray-900 hover:bg-gray-800 focus-visible:bg-gray-800 text-cyber-lime focus-visible:outline-none font-bold flex items-center gap-2 transition-colors uppercase"
      ...
      <div className="flex-1 relative bg-[#0a0a0a] overflow-hidden group">
        ...
        <div className="absolute bottom-4 right-6 flex items-center gap-4 pointer-events-none opacity-0 group-hover:opacity-100 group-focus-within:opacity-100 transition-opacity">
            <span className="text-[10px] font-mono text-gray-600 bg-black/50 px-2 py-1 rounded border border-gray-900">
                {prompt.length} CHR
            </span>
            <span className="text-[10px] font-mono text-gray-600 bg-black/50 px-2 py-1 rounded border border-gray-900 flex items-center gap-1">
                <kbd className="font-sans">{navigator.platform.toUpperCase().includes('MAC') ? 'Cmd' : 'Ctrl'}</kbd> + <kbd className="font-sans">Enter</kbd> TO TEST
            </span>
        </div>
