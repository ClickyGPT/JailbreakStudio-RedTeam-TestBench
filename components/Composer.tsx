    ...
    <div className="flex-1 flex flex-col h-full relative">
      <div className="p-3 border-b border-gray-900 flex justify-between items-center bg-cyber-black">
        ...
        <div className="flex gap-2">
             ...
             <div className="relative group">
                ...
                <div className="absolute right-0 top-full mt-1 w-48 bg-cyber-black border border-gray-800 rounded shadow-[0_0_20px_rgba(0,0,0,0.8)] hidden group-hover:block group-focus-within:block z-20 backdrop-blur-xl">
                    <button 
                        ...
                        className="block w-full text-left px-4 py-3 text-xs hover:bg-cyber-lime hover:text-black focus:bg-cyber-lime focus:text-black outline-none text-gray-300 transition-colors border-b border-gray-900"
                    ...
                    <button 
                        ...
                        className="block w-full text-left px-4 py-3 text-xs hover:bg-cyber-lime hover:text-black focus:bg-cyber-lime focus:text-black outline-none text-gray-300 transition-colors"
             ...
             <div className="relative group">
                <button 
                    className="px-3 py-1 text-xs font-mono font-bold bg-gray-900 text-cyber-muted border border-gray-700 rounded hover:border-cyber-lime hover:text-cyber-lime focus:border-cyber-lime focus:text-cyber-lime outline-none transition-all uppercase tracking-wider"
                ...
                <div className="absolute right-0 top-full mt-1 w-64 bg-cyber-black border border-gray-800 rounded shadow-2xl hidden group-hover:block group-focus-within:block z-20 max-h-80 overflow-y-auto backdrop-blur-xl">
                    ...
                    {systemVars.map((v) => (
                        <button 
                            ...
                            className="block w-full text-left px-4 py-2 text-xs hover:bg-cyber-lime hover:text-black focus:bg-cyber-lime focus:text-black outline-none text-gray-300 border-b border-gray-900 last:border-0 group/item transition-all"
                    ...
                    <div className="border-t border-gray-800 sticky bottom-0 bg-cyber-black">
                        <button 
                            ...
                            className="block w-full text-left px-4 py-3 text-xs bg-gray-900 hover:bg-gray-800 focus:bg-gray-800 text-cyber-lime font-bold flex items-center gap-2 transition-colors outline-none uppercase"
