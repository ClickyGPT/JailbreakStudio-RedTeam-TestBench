...
// BOLT OPTIMIZATION: Detect platform at module level to avoid unnecessary state/re-render.
...
const Composer: React.FC<ComposerProps> = React.memo(({ prompt, setPrompt, onRunTest, isRunning, onShare }) => {
  // BOLT OPTIMIZATION: Use useRef for element reference to avoid re-rendering on capture.
