...
const Composer: React.FC<ComposerProps> = React.memo(({ prompt, setPrompt, onRunTest, isRunning, onShare }) => {
  ...
  // BOLT OPTIMIZATION: Memoize variable filtering to avoid O(n) work on every render
  // (though n is small here, it's good practice for scalability and keeps renders lean)
