  ...
  return (
    <div className="flex-1 flex flex-col h-full relative">
      ...
      <div className="flex-1 relative bg-[#0a0a0a] overflow-hidden group">
        ...
        <div className="absolute bottom-4 right-6 pointer-events-none select-none text-[10px] font-mono text-gray-700 uppercase tracking-widest bg-black/50 px-2 py-1 rounded backdrop-blur-sm border border-gray-900/50">
