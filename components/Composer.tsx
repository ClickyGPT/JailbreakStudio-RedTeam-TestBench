  ...
  return (
    <div className="flex-1 flex flex-col h-full relative">
      ...
      <div className="flex-1 relative bg-[#0a0a0a] overflow-hidden group">
        ...
        <div className="absolute bottom-4 right-6 pointer-events-none select-none opacity-0 group-focus-within:opacity-100 transition-opacity duration-300">
            <span className="text-[10px] font-mono text-gray-700 bg-black/40 px-2 py-1 rounded border border-gray-900">
                PRESS <span className="text-cyber-lime">{isMac ? '⌘' : 'CTRL'} + ENTER</span> TO SIMULATE
            </span>
        </div>
