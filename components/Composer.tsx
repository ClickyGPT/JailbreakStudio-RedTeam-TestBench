    ...
    <div className="flex-1 flex flex-col h-full relative">
      <div className="p-3 border-b border-gray-900 flex justify-between items-center bg-cyber-black">
        ...
        <div className="flex gap-2">
             ...
             <div className="relative group">
                <button 
                    className="px-3 py-1 text-xs font-mono font-bold bg-gray-900 text-cyber-muted border border-gray-700 rounded hover:border-cyber-lime hover:text-cyber-lime transition-all uppercase tracking-wider focus-visible:ring-2 focus-visible:ring-cyber-lime focus-visible:outline-none"
      ...
      <div className="flex-1 relative bg-[#0a0a0a] overflow-hidden group">
        ...
        <div className="absolute bottom-4 right-6 pointer-events-none select-none">
            <span className="text-[10px] font-mono text-gray-700 tracking-widest uppercase">
                Chars: <span className={prompt.length > 2000 ? 'text-cyber-red' : 'text-cyber-muted'}>{prompt.length.toLocaleString()}</span>
            </span>
        </div>
