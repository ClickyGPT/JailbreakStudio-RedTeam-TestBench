    ...
    <div className="flex-1 flex flex-col h-full relative">
      ...
      <div className="p-4 border-t border-gray-900 bg-cyber-black flex justify-between items-center">
        <div className="flex items-center gap-4">
            <button
                onClick={onShare}
                className="flex items-center gap-2 text-xs font-bold font-sans text-cyber-muted hover:text-white focus-visible:bg-cyber-lime focus-visible:text-black focus-visible:outline-none transition-colors uppercase tracking-widest px-1 py-0.5 rounded"
            ...
            <button
                ...
                className="flex items-center gap-2 text-xs font-bold font-sans text-cyber-muted hover:text-white focus-visible:bg-cyber-lime focus-visible:text-black focus-visible:outline-none transition-colors uppercase tracking-widest disabled:opacity-50 disabled:cursor-not-allowed px-1 py-0.5 rounded"
        ...
        <button
            ...
            className={`flex items-center gap-2 px-8 py-3 text-sm font-bold font-sans tracking-wider focus-visible:bg-cyber-lime focus-visible:text-black focus-visible:outline-none transition-all duration-300 relative overflow-hidden group ${
                isRunning 
