    ...
    <div className="flex-1 flex flex-col h-full relative">
      <div className="p-3 border-b border-gray-900 flex justify-between items-center bg-cyber-black">
        ...
        <div className="flex gap-2">
             ...
             <div className="relative group">
                <button 
                    className="px-3 py-1 text-xs font-mono font-bold bg-gray-900 text-cyber-muted border border-gray-700 rounded hover:border-cyber-lime hover:text-cyber-lime focus-visible:bg-cyber-lime focus-visible:text-black focus-visible:outline-none transition-all uppercase tracking-wider"
      ...
      <div className="flex-1 relative bg-[#0a0a0a] overflow-hidden group">
        <textarea
            ...
            className="w-full h-full bg-transparent text-gray-200 font-mono p-6 resize-none focus:outline-none focus:ring-1 focus:ring-cyber-lime text-sm leading-relaxed placeholder-gray-800 selection:bg-cyber-lime selection:text-black"
            spellCheck={false}
        />
      ...
      <div className="p-4 border-t border-gray-900 bg-cyber-black flex justify-between items-center">
        ...
        <button
            ...
            className={`flex items-center gap-2 px-8 py-3 text-sm font-bold font-sans tracking-wider transition-all duration-300 relative overflow-hidden group focus-visible:bg-white focus-visible:text-black focus-visible:outline-none ${
                isRunning 
                ? 'bg-gray-800 text-gray-500 cursor-not-allowed' 
                : 'bg-cyber-lime text-black hover:bg-[#c0ff00] hover:shadow-[0_0_20px_rgba(211,253,80,0.4)]'
            }`}
            title={`Simulate this attack (${isMac ? '⌘↵' : 'Ctrl+Enter'})`}
        >
