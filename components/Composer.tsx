  ...
  return (
    <div className="flex-1 flex flex-col h-full relative">
      <div className="p-3 border-b border-gray-900 flex justify-between items-center bg-cyber-black">
        ...
        <div className="flex gap-2">
             ...
             <div className="relative group">
                ...
                <div className="absolute right-0 top-full mt-1 w-48 bg-cyber-black border border-gray-800 rounded shadow-[0_0_20px_rgba(0,0,0,0.8)] invisible opacity-0 group-hover:visible group-hover:opacity-100 focus-within:visible focus-within:opacity-100 transition-all duration-200 z-20 backdrop-blur-xl">
                    <button 
             ...
             <div className="relative group">
                <button 
                    className="px-3 py-1 text-xs font-mono font-bold bg-gray-900 text-cyber-muted border border-gray-700 rounded hover:border-cyber-lime hover:text-cyber-lime focus-visible:ring-1 focus-visible:ring-cyber-lime focus-visible:ring-offset-1 focus-visible:ring-offset-black outline-none transition-all uppercase tracking-wider"
                    title="Insert predefined or custom prompt variables"
                >
                   + VARS
                </button>
                <div className="absolute right-0 top-full mt-1 w-64 bg-cyber-black border border-gray-800 rounded shadow-2xl invisible opacity-0 group-hover:visible group-hover:opacity-100 focus-within:visible focus-within:opacity-100 transition-all duration-200 z-20 max-h-80 overflow-y-auto backdrop-blur-xl">
                    {systemVars.length > 0 && (
      ...
      <div className="flex-1 relative bg-[#0a0a0a] overflow-hidden group">
        ...
        <div className="absolute bottom-4 right-6 pointer-events-none select-none text-[10px] font-mono text-cyber-muted flex items-center gap-1 opacity-50 group-focus-within:opacity-100 transition-opacity">
            <span>{prompt.length}</span>
            <span className="tracking-widest">CHARS</span>
        </div>
      ...
      <div className="p-4 border-t border-gray-900 bg-cyber-black flex justify-between items-center">
        <div className="flex items-center gap-4">
            <button
                onClick={onShare}
                className="flex items-center gap-2 text-xs font-bold font-sans text-cyber-muted hover:text-white focus-visible:ring-1 focus-visible:ring-cyber-lime focus-visible:ring-offset-1 focus-visible:ring-offset-black outline-none transition-colors uppercase tracking-widest"
            ...
            <button
                ...
                className="flex items-center gap-2 text-xs font-bold font-sans text-cyber-muted hover:text-white focus-visible:ring-1 focus-visible:ring-cyber-lime focus-visible:ring-offset-1 focus-visible:ring-offset-black outline-none transition-colors uppercase tracking-widest disabled:opacity-50 disabled:cursor-not-allowed"
        ...
        <button
            ...
            className={`flex items-center gap-2 px-8 py-3 text-sm font-bold font-sans tracking-wider transition-all duration-300 relative overflow-hidden group focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-black outline-none ${
                isRunning 
                ? 'bg-gray-800 text-gray-500 cursor-not-allowed' 
                : 'bg-cyber-lime text-black hover:bg-[#c0ff00] hover:shadow-[0_0_20px_rgba(211,253,80,0.4)]'
            }`}
            title="Simulate this attack against the safety filter (Ctrl+Enter)"
        >
