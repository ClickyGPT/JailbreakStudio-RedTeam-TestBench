  ...
  return (
    <div className="flex-1 flex flex-col h-full relative">
      <div className="p-3 border-b border-gray-900 flex justify-between items-center bg-cyber-black">
        ...
        <div className="flex gap-2">
             ...
             <div className="relative group">
                <button 
                    className="px-3 py-1 text-xs font-mono font-bold bg-cyber-lime/5 text-cyber-lime border border-cyber-lime/30 rounded hover:bg-cyber-lime hover:text-black flex items-center gap-1 disabled:opacity-50 disabled:cursor-not-allowed transition-all uppercase tracking-wider focus-visible:outline-none focus-visible:bg-cyber-lime focus-visible:text-black"
             ...
             <div className="relative group">
                <button 
                    className="px-3 py-1 text-xs font-mono font-bold bg-gray-900 text-cyber-muted border border-gray-700 rounded hover:border-cyber-lime hover:text-cyber-lime transition-all uppercase tracking-wider focus-visible:outline-none focus-visible:border-cyber-lime focus-visible:text-cyber-lime"
                    aria-haspopup="true"
                ...
                <div className="absolute right-0 top-full mt-1 w-64 bg-cyber-black border border-gray-800 rounded shadow-2xl hidden group-hover:block group-focus-within:block z-20 max-h-80 overflow-y-auto backdrop-blur-xl">
                    ...
                    {systemVars.map((v) => (
                        <button 
                            ...
                            className="block w-full text-left px-4 py-2 text-xs hover:bg-cyber-lime hover:text-black focus:bg-cyber-lime focus:text-black focus:outline-none text-gray-300 border-b border-gray-900 last:border-0 group/item transition-all"
                    ...
                    <div className="border-t border-gray-800 sticky bottom-0 bg-cyber-black">
                        ...
                        className="block w-full text-left px-4 py-3 text-xs bg-gray-900 hover:bg-gray-800 focus:bg-gray-800 focus:outline-none text-cyber-lime font-bold flex items-center gap-2 transition-colors uppercase"
      ...
      <div className="flex-1 relative bg-[#0a0a0a] overflow-hidden group">
        ...
        <div className="absolute bottom-4 right-6 text-[10px] font-mono text-gray-600 pointer-events-none select-none opacity-50 group-focus-within:opacity-100 transition-opacity">
