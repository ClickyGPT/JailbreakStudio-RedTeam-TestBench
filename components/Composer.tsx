...
const Composer: React.FC<ComposerProps> = React.memo(({ prompt, setPrompt, onRunTest, isRunning, onShare }) => {
  ...
  return (
    <div className="flex-1 flex flex-col h-full relative">
             ...
             <div className="relative group">
                ...
                <div className="absolute right-0 top-full mt-1 w-48 bg-cyber-black border border-gray-800 rounded shadow-[0_0_20px_rgba(0,0,0,0.8)] hidden group-hover:block group-focus-within:block z-20 backdrop-blur-xl">
                    <button 
                        ...
                        className="block w-full text-left px-4 py-3 text-xs hover:bg-cyber-lime hover:text-black text-gray-300 transition-colors border-b border-gray-900 focus-visible:ring-1 focus-visible:ring-cyber-lime focus-visible:outline-none"
                    ...
                    <button 
                        ...
                        className="block w-full text-left px-4 py-3 text-xs hover:bg-cyber-lime hover:text-black text-gray-300 transition-colors focus-visible:ring-1 focus-visible:ring-cyber-lime focus-visible:outline-none"
                ...
                <div className="absolute right-0 top-full mt-1 w-64 bg-cyber-black border border-gray-800 rounded shadow-2xl hidden group-hover:block group-focus-within:block z-20 max-h-80 overflow-y-auto backdrop-blur-xl">
                    ...
                    {systemVars.map((v) => (
                        <button 
                            ...
                            className="block w-full text-left px-4 py-2 text-xs hover:bg-cyber-lime hover:text-black text-gray-300 border-b border-gray-900 last:border-0 group/item transition-all focus-visible:ring-1 focus-visible:ring-cyber-lime focus-visible:outline-none"
                    ...
                    <div className="border-t border-gray-800 sticky bottom-0 bg-cyber-black">
                        <button 
                            ...
                            className="block w-full text-left px-4 py-3 text-xs bg-gray-900 hover:bg-gray-800 text-cyber-lime font-bold flex items-center gap-2 transition-colors uppercase focus-visible:ring-1 focus-visible:ring-cyber-lime focus-visible:outline-none"
      ...
      <div className="flex-1 relative bg-[#0a0a0a] overflow-hidden group transition-all focus-within:ring-1 focus-within:ring-cyber-lime/20">
        <textarea
            ref={setTextAreaRef}
            value={prompt}
        ...
        <div
          id="char-counter"
          className="absolute bottom-4 right-6 text-[10px] font-mono text-cyber-muted pointer-events-none select-none opacity-0 group-focus-within:opacity-100 transition-opacity"
        >
      ...
      <div className="p-4 border-t border-gray-900 bg-cyber-black flex justify-between items-center">
        <div className="flex items-center gap-4">
            <button
                onClick={onShare}
                className="flex items-center gap-2 text-xs font-bold font-sans text-cyber-muted hover:text-white transition-colors uppercase tracking-widest focus-visible:ring-1 focus-visible:ring-cyber-lime focus-visible:outline-none rounded px-1"
            ...
            <button
                ...
                className="flex items-center gap-2 text-xs font-bold font-sans text-cyber-muted hover:text-white transition-colors uppercase tracking-widest disabled:opacity-50 disabled:cursor-not-allowed focus-visible:ring-1 focus-visible:ring-cyber-lime focus-visible:outline-none rounded px-1"
