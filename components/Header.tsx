  ...
  return (
    <header className="border-b border-gray-900 bg-cyber-black p-4 flex items-center justify-between sticky top-0 z-50">
      ...
      <nav className="flex gap-6 text-sm font-sans font-medium text-cyber-muted">
        <button type="button" className="hover:text-cyber-lime transition-colors duration-300 focus-visible:bg-cyber-lime focus-visible:text-black focus-visible:outline-none px-2 rounded">DOCS</button>
        <button type="button" className="hover:text-cyber-lime transition-colors duration-300 focus-visible:bg-cyber-lime focus-visible:text-black focus-visible:outline-none px-2 rounded">ARSENAL</button>
        <button type="button" className="hover:text-cyber-lime transition-colors duration-300 focus-visible:bg-cyber-lime focus-visible:text-black focus-visible:outline-none px-2 rounded">FORUM</button>
      </nav>
    </header>
  );
});
