  ...
  if (!isOpen) {
    return (
        <button 
            ...
            className="fixed bottom-6 right-6 bg-cyber-lime text-black p-4 rounded-full shadow-[0_0_20px_rgba(211,253,80,0.4)] hover:scale-105 hover:bg-white transition-all z-50 flex items-center gap-2 font-bold font-sans tracking-wide focus-visible:ring-2 focus-visible:ring-black focus-visible:ring-offset-2"
        >
            <Bot size={24} />
    ...
    <div className="fixed bottom-6 right-6 w-[90vw] md:w-[400px] h-[600px] bg-cyber-black border border-cyber-lime shadow-[0_0_40px_rgba(0,0,0,0.9)] rounded-lg flex flex-col z-50 overflow-hidden font-sans">
        ...
        <div className="p-4 bg-cyber-lime flex justify-between items-center">
            ...
            <button
                ...
                className="text-black hover:text-white transition-colors focus-visible:ring-2 focus-visible:ring-black rounded"
            >
                <X size={20} />
            </button>
        </div>
