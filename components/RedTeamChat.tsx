...
const RedTeamChat: React.FC = React.memo(() => {
  ...
  if (!isOpen) {
    return (
        <button 
            ...
            className="fixed bottom-6 right-6 bg-cyber-lime text-black p-4 rounded-full shadow-[0_0_20px_rgba(211,253,80,0.4)] hover:scale-105 hover:bg-white focus-visible:ring-2 focus-visible:ring-black focus-visible:ring-offset-2 transition-all z-50 flex items-center gap-2 font-bold font-sans tracking-wide outline-none"
        >
            <Bot size={24} />
  ...
  return (
    <div
      className="fixed bottom-6 right-6 w-[90vw] md:w-[400px] h-[600px] bg-cyber-black border border-cyber-lime shadow-[0_0_40px_rgba(0,0,0,0.9)] rounded-lg flex flex-col z-50 overflow-hidden font-sans"
      role="dialog"
      aria-label="Zephyr AI Chat"
    >
        {/* Header */}
        ...
        <div className="p-4 bg-cyber-black border-t border-gray-900 flex gap-2">
            ...
            <button 
                ...
                className="bg-cyber-lime text-black p-3 rounded hover:bg-white focus-visible:ring-2 focus-visible:ring-black focus-visible:ring-offset-2 transition-colors disabled:opacity-50 disabled:bg-gray-800 disabled:text-gray-500 outline-none"
            >
                <Send size={18} />
            </button>
        </div>
