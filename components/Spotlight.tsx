...
/**
 * BOLT OPTIMIZATION: High-frequency mouse tracking isolated in a memoized component.
 * Uses direct DOM manipulation to update CSS variables, bypassing React's
 * reconciliation cycle for purely decorative updates.
 */
