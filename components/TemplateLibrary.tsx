          ...
          <div className="space-y-2">
            {CORE_TEMPLATES.map((template) => (
              <button
                ...
                className="w-full text-left p-4 rounded bg-gray-900/30 border border-gray-800 hover:border-cyber-lime hover:bg-gray-900 hover:shadow-[0_0_15px_rgba(211,253,80,0.1)] focus:outline-none focus:ring-1 focus:ring-cyber-lime transition-all duration-300 group relative overflow-hidden"
