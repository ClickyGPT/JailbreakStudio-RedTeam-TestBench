...
const VariableManagerModal: React.FC<VariableManagerModalProps> = ({ variables, onSave, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-[70] p-4 backdrop-blur-sm">
      <div className="bg-cyber-gray border border-gray-700 w-full max-w-lg rounded-lg shadow-2xl overflow-hidden flex flex-col max-h-[80vh]" role="dialog" aria-modal="true" aria-labelledby="var-manager-title">
          ...
          <div className="p-4 bg-gray-900 border-b border-gray-800 space-y-3">
            ...
            <div className="flex flex-col gap-2">
                ...
                <button 
                    ...
                    className="bg-cyber-lime/10 border border-cyber-lime/30 text-cyber-lime py-2 rounded text-xs font-bold font-mono hover:bg-cyber-lime/20 focus-visible:bg-cyber-lime/30 focus-visible:outline-none flex items-center justify-center gap-2 disabled:opacity-50"
                >
