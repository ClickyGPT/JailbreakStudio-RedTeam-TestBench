                        ...
                        <div className="w-8 flex justify-center">
                            {!v.isSystem ? (
                                <button 
                                    ...
                                    className="text-gray-600 hover:text-cyber-red p-1 opacity-50 group-hover:opacity-100 transition-opacity focus-visible:opacity-100 focus-visible:text-cyber-red focus-visible:outline-none"
