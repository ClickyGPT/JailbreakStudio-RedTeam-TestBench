...
// This is significantly faster than iterating over an array and calling .toLowerCase().includes()
// for each keyword, especially for large output strings from the model.
