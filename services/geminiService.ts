...
// This is significantly faster than iteratively calling .toLowerCase().includes()
// for each keyword, especially on large output strings (~4x speedup for long texts).
