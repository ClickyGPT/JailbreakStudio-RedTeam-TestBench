...
// This is significantly faster than looping and performing .toLowerCase() on every check.
// We only create the regex if there are keywords to avoid matching everything on an empty list.
