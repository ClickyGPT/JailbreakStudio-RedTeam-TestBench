...
export const simulateAttack = async (prompt: string): Promise<SimulationResult> => {
  ...
  try {
    ...
    // BOLT OPTIMIZATION: Format latency to 2 decimal places for high-precision reporting.
    ...
    // BOLT OPTIMIZATION: Lowercase the source string once rather than in every loop iteration.
    // Combined with pre-lowercased keywords, this significantly improves matching performance.
