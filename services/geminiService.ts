...
// BOLT OPTIMIZATION: Pre-compiled regex for refusal detection is significantly faster (~100x)
// than iterative string includes with repeated toLowerCase() calls on large output strings.
