...
// BOLT OPTIMIZATION: Pre-compile refusal detection regex at module level to avoid
// redundant string transformations and iterative keyword checks on every simulation.
