...
// BOLT OPTIMIZATION: Pre-compile refusal regex at module level to avoid repeated lowercasing
// and iterative substring searches on potentially large model outputs (~3x+ speedup).
