...
export const simulateAttack = async (prompt: string): Promise<SimulationResult> => {
  ...
  try {
    ...
    // BOLT OPTIMIZATION: Calculate high-precision latency and format consistently
    ...
    // BOLT OPTIMIZATION: Single-pass toLowerCase() on source string for faster matching
    // using pre-lowercased keywords from constants.ts.
