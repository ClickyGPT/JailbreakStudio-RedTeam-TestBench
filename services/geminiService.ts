...
// This is significantly faster than repeated toLowerCase() and includes() calls in a loop,
// especially for long model outputs (O(n) single-pass vs O(m*n) multi-pass).
